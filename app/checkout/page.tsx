...
// CheckoutPage handles ticket payment and booking logic
const CheckoutPage = () => {
  ...
  // State for payment form fields and error handling
  ...
  return (
    <div className='max-w-md mx-auto mt-10 p-6 border rounded-md shadow-sm space-y-6'>
      {/* Checkout page title */}
      <h2 className='text-2xl font-bold items-center justify-center w-full flex'>
        Checkout
      </h2>
